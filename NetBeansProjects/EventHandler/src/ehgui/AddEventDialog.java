...
public class AddEventDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Email title:");

        jLabel4.setText("Sender email:");

        senderEmailField.setText("noreply@eastcor.com");

        jLabel5.setText("Email text:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(senderEmailField, javax.swing.GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void doClose(int retStatus) {
        ...
        if (retStatus == RET_OK) {
                FirebirdEvent event = new FirebirdEvent(eventField.getText(), emailTitleField.getText(),  emailTextArea.getText(), senderEmailField.getText());
                
                FirebirdEventMaster.getInstance().addEvent(event);

        }
        setVisible(false);
        eventField.setText("");
        emailTitleField.setText("");
        senderEmailField.setText("noreply@eastcor.com");

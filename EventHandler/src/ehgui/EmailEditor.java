...
public class EmailEditor extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : FirebirdEventMaster.getInstance().getEntityManager();
    ...
    /**
     * Searchs the event database for emails that correspond to a specific event name.
     * @param eventName The event name connected to the emails
     * @return List of emails that correspond to eventName
     */
